      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', 'Error logging in. Please try again.');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWF0dC1jb25zIiwiYSI6ImNrd2wxcGFsNjF4dWQyeHA4dm4yYWVmczYifQ.3XovrRdP-_6Dj6uD04XuFg';
...
var stripe = Stripe('pk_test_51KCTtZCxSfLt5oj1IQy1tWJZaeoS53p5jmy8ejCGQimV6ejEYex0GVCzg5EkWXiZElNGW2lDOfIxq21rHwEMX8r500JB1Q2hfD');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //use stripe object to create checkout form + charge the credit card
